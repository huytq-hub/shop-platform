...
class ConfigSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $configs = [
            ...
            'login_social.google.client_secret' => env('LOGIN_SOCIAL_GOOGLE_CLIENT_SECRET', ''),
            'login_social.google.redirect' => env('LOGIN_SOCIAL_GOOGLE_REDIRECT', 'http://localhost:8000/auth/google/callback'),
            'login_social.facebook.active' => '1',
            'login_social.facebook.client_id' => env('LOGIN_SOCIAL_FACEBOOK_CLIENT_ID', ''),
            'login_social.facebook.client_secret' => env('LOGIN_SOCIAL_FACEBOOK_CLIENT_SECRET', ''),
            'login_social.facebook.redirect' => env('LOGIN_SOCIAL_FACEBOOK_REDIRECT', 'http://localhost:8000/auth/facebook/callback'),
        ];
